...
func (_m *Access) Get(ctx context.Context, sessionKey string, stateType reflect.Type) (any, error) {
	...
	var r0 any
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, reflect.Type) (any, error)); ok {
		return rf(ctx, sessionKey, stateType)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, reflect.Type) any); ok {
...
func (_c *Access_Get_Call) Return(_a0 any, _a1 error) *Access_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Access_Get_Call) RunAndReturn(run func(context.Context, string, reflect.Type) (any, error)) *Access_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Set provides a mock function with given fields: ctx, sessionKey, state
func (_m *Access) Set(ctx context.Context, sessionKey string, state any) error {
...
func (_c *Access_Set_Call) Run(run func(ctx context.Context, sessionKey string, state any)) *Access_Set_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Access_Set_Call) RunAndReturn(run func(context.Context, string, any) error) *Access_Set_Call {
	_c.Call.Return(run)
	return _c
}
